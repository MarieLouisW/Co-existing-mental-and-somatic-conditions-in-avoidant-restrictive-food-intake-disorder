...
author: "Marie-Louis Wronski, Ralf Kuja-Halkola, Elin Hedlund, Miriam I. Martini, Paul Lichtenstein, Sebastian Lundström, Henrik Larsson, Mark Taylor, Nadia Micali, Cynthia M. Bulik, Lisa Dinkler"
output:
...
# ARFID phenotype at age 9/12 (6-12)
...
# Descriptives
## Descriptives I for MS Figure 1 and SM Table S2
...
## Descriptives II for MS Figure 1 and SM Table S2
...
## Descriptives IV for SM Table S2 (Chi-squared tests)
...
# Define comorbidities - ICD chapters, individual/single diagnoses, and grouped conditions (SM Table S1)
...
df_comorb_diagnoses_pre %>%
  ...
  knitr::kable(format="html", align="l", digits=2,
               caption="N of events in ARFID (for SM Table S1) - I") %>%
  kable_paper(bootstrap_options="striped", full_width=FALSE, 
              position="left", html_font="Arial", font_size="10")
...
df_comorb_chapters_pre %>%
  ...
  dplyr::select(comorb, n) %>%
  knitr::kable(format="html", align="l", digits=2,
               caption="N of events in ARFID (for SM Table S1) - II") %>%
  kable_paper(bootstrap_options="striped", full_width=FALSE, 
              position="left", html_font="Arial", font_size="10")
...
df_comorb_disordergroups_pre %>%
  ...
  dplyr::select(comorb, n) %>%
  knitr::kable(format="html", align="l", digits=2,
               caption="N of events in ARFID (for SM Table S1) - III") %>%
  kable_paper(bootstrap_options="striped", full_width=FALSE, 
              position="left", html_font="Arial", font_size="10")
```
...
### Sex-stratified model (SM Table S5)
...
### Age group-stratified model (SM Table S6)
...
## Tables for number of distinct diagnoses (SM Tables S8 and S9) and inpatient treatment duration (SM Tables S10 and S11)
...
## Cumulative incidence table/absolute risk assessment (SM Table S7)
